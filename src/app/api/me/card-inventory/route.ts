...
import { parseCardInventoryQuery } from "@/server/bonus-packs/input";
import { listCardInventory } from "@/server/bonus-packs/service";
...
export async function GET(request: Request): Promise<Response> {
  ...
  try {
    ...
    const query = parseCardInventoryQuery(request.url);
