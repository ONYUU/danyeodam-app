...
| 2026-08-15 | 첫 유효 방문은 그날의 지역 collection pool만 확정하고 결과를 방문 단일 spot에 묶지 않음. 특별은 지역 내 미보유 우선, 완성 후 중복; pool version은 발급 시 snapshot | 서울 컬렉션 전체 보너스라는 승인 목업과 지역 순차 공개 구조 유지 |
